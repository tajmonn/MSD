...
[ ] = { { ( char_T * ) ( & rtB . fc10ryf0wg ) , 0 , 0 , 6 } , { ( char_T * )
( & rtDW . fxoxjzkfy4 . AQHandles ) , 11 , 0 , 7 } } ; static
DataTypeTransitionTable rtBTransTable = { 2U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . dydt_IC )
, 0 , 0 , 6 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
