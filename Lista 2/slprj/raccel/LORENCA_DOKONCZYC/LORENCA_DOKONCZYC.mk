...
MODEL                = LORENCA_DOKONCZYC
MODULES              = rt_logging_simtarget.c LORENCA_DOKONCZYC.c LORENCA_DOKONCZYC_capi.c LORENCA_DOKONCZYC_data.c LORENCA_DOKONCZYC_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = LORENCA_DOKONCZYC.exe
MAKEFILE             = LORENCA_DOKONCZYC.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2021b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2021b
START_DIR            = C:/Users/Tymon/Desktop/Studia/SEMEST~2/MSD/LISTA2~1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = LORENCA_DOKONCZYC_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/LORENCA_DOKONCZYC \
